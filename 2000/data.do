...
label define builtyr2 07	"1990-1994", add
label define builtyr2 08	"1995-1999", add
label values builtyr2 builtyr2
tabulate builtyr2

* ACS 2000 labels "unitstr"
...
reg lrent b4.rooms b7.builtyr2 b3.unitsstr i.metarea [aw=hhwt] if samplemetarea
