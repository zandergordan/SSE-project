...
* ACS 2009 labels "builtyr2"
label define builtyr2 01	"1939 or earlier", add
label define builtyr2 02	"1940-1949", add
label define builtyr2 03	"1950-1959", add
label define builtyr2 04	"1960-1969", add
label define builtyr2 05	"1970-1979", add
label define builtyr2 06	"1980-1989", add
label define builtyr2 07	"1990-1999", add
label define builtyr2 09	"2000-2004", add
label define builtyr2 10	"2005", add
label define builtyr2 11	"2006", add
label define builtyr2 12	"2007", add
label define builtyr2 13	"2008", add
label define builtyr2 14	"2009", add
label values builtyr2 builtyr2
tabulate builtyr2

* ACS 2009 labels "unitstr"
...
* reference groups are 4="4 rooms", 9="2000-2004", 3="1-family detached"
* note: xtreg cannot deal with weights within areas
reg lrent b4.rooms b9.builtyr2 b3.unitsstr i.metarea [aw=hhwt] if samplemetarea
